...
class Node2Vec:
    ...
    def __init__(self, graph, walk_length, num_walks, p=1.0, q=1.0, workers=1, clust={},clust_dic={},metric1={},same_metric1_dic={},metric2={}):

        self.graph = graph
        self._embeddings = {}
        #t1 = time.time()
        self.walker = RandomWalker(graph, p=p, q=q, clust=clust, clust_dic=clust_dic, metric1=metric1, same_metric1_dic=same_metric1_dic,metric2=metric2)
        #t2 = time.time()
        #print("randomwalk took: ",t2-t1)
